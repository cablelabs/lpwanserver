...
exports.initialize = function (app, server) {
  ...
  app.get('/api/passwordPolicies/company/:companyId',
    ...
    function (req, res) {
      ...
      modelAPI.passwordPolicies.list(companyId).then(function ([ rules ]) {
        ...
        .catch(function (err) {
          logger.error('Error getting passwordPolicies: ', err)
  ...
  function (req, res) {
    ...
    modelAPI.passwordPolicies.load(id).then(function (pp) {
      ...
      .catch(function (err) {
        logger.error('Error getting passwordPolicy ' + id + ': ', err)
        restServer.respond(res, err)
      })
  })
  ...
  function (req, res) {
    ...
    modelAPI.passwordPolicies.load(data.id).then(function (pp) {
      ...
      .catch(function (err) {
        logger.error('Error getting PasswordPolicy ' + req.params.id + ': ', err)
        restServer.respond(res, err)
      })
  })
  ...
  function (req, res) {
    ...
    if (req.company.type === 'ADMIN') {
      modelAPI.passwordPolicies.remove(id).then(function () {
        ...
        .catch(function (err) {
          logger.error('Error deleting passwordPolicy ' + id + ': ', err)
          restServer.respond(res, err)
        })
    }
    else {
