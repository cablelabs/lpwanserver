...
module.exports = class Company {
  ...
  async remove (id) {
    ...
    try {
      ...
      logger.error('Error deleting company\'s applications:', err)
    }
    try {
      // Delete users
      ...
      logger.error('Error deleting company\'s users:', err)
    }
    try {
      ...
      logger.error('Error deleting company\'s deviceProfiles:', err)
    }
    try {
      ...
      logger.error('Error deleting company\'s PasswordPolicies:', err)
    }
    try {
      ...
      logger.error('Error deleting company\'s networkTypeLinks:', err)
    }
    await DB.remove({ id })
  }
}
